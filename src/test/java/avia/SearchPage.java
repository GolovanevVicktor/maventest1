...
public class SearchPage extends CommonPage{
    ...
    if(page==null) {page=new SearchPage();} 
     ...
     //Map elements=new HashMap<String,String>();
    //elements.put("departure",".//form[@class='AviaSearchForm']//input[contains(@data-reactid,'1$segment-4.0.')]");
    ...
    elements.put("departure",".//form[@class='AviaSearchForm']//input[contains(@data-reactid,'1$segment-4.0.')]");
    elements.put("arrival",".//form[@class='AviaSearchForm']//input[contains(@data-reactid,'1$segment-4.1.')]");
    elements.put("date",".//form[@class='AviaSearchForm']//input[contains(@data-reactid,'1$segment-4.2.')]");
    }*/
}
